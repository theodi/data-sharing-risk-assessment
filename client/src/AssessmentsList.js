      ...
      {assessmentsList.map((d, i) => {
        ...
        if (date_created_show && date_modified_show){
          return (
            ...
            >
              <td><Link to="/assessment" onClick={() => dispatch(startAssessment(i))}>{name}</Link></td>
              <td><Link to="/assessment" onClick={() => dispatch(startAssessment(i))}>{id}</Link></td>
              <td><Link to="/assessment" onClick={() => dispatch(startAssessment(i))} className="">{dateCreated} </Link></td>
              <td><Link to="/assessment" onClick={() => dispatch(startAssessment(i))} className="">{dateModified} </Link></td>
              <td><Link to="/assessment" onClick={() => dispatch(startAssessment(i))} className="">{owner}</Link></td>
              <td><Link to="/assessment"  onClick={() => dispatch(startAssessment(i))} className="">{percentComplete}%</Link></td>
              <td onClick={() => dispatch(deleteAssessment(i))} className="delete">
