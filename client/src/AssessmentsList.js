      ...
      {assessmentsList.map((d, i) => {
        ...
        if (date_created_show && date_modified_show){
          return (
            ...
            >
              <td><Link to="/assessment" onClick={() => dispatch(startAssessment(d._id))}>{id}</Link></td>
              <td><Link to="/assessment" onClick={() => dispatch(startAssessment(d._id))}>{name}</Link></td>
              <td><Link to="/assessment" onClick={() => dispatch(startAssessment(d._id))} className="">{dateCreated} </Link></td>
              <td><Link to="/assessment" onClick={() => dispatch(startAssessment(d._id))} className="">{dateModified} </Link></td>
              <td><Link to="/assessment" onClick={() => dispatch(startAssessment(d._id))} className="">{owner}</Link></td>
              <td><Link to="/assessment"  onClick={() => dispatch(startAssessment(d._id))} className="">{percentComplete}%</Link></td>
